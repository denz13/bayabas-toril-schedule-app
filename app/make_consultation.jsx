...
export default function MakeConsultationScreen() {
  ...
  const handleUpdateConsultationSave = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Error",
        "Failed to update consultation schedule. Please try again.",
      );
    }
  };
  ...
  return (
    <View style={[styles.container, { backgroundColor: backgroundColor }]}>
      <StatusBar
        ...
        backgroundColor={isDark ? "#1a1a1a" : "#8B1538"}
        translucent={false}
      />
          ...
          <View style={styles.contentContainer}>
            ...
            {isLoading ? (
                  ...
                  >
                    <View style={styles.sectionHeader}>
                      ...
                      <View style={styles.sectionInfo}>
                        <ThemedText
                          style={[styles.sectionName, { color: textColor }]}
                        >
                          {consultation.purpose}
                        </ThemedText>
                        <ThemedText
                          style={[styles.sectionGrade, { color: iconColor }]}
                        >
                          {consultation.teacher_name}
                        </ThemedText>
                      </View>
                    ...
                    <View
                      style={[
                        ...
                        { borderTopColor: isDark ? "#fff" : "#f0f0f0" },
                      ]}
                    >
                      <View style={styles.detailRow}>
                        ...
                        />
                        <ThemedText
                          style={[styles.detailText, { color: iconColor }]}
                        >
                          Date: {consultation.consultation_date}
                        </ThemedText>
                      </View>
                      ...
                      {consultation.status === "declined" &&
                        !!consultation.decline_reason && (
                          <View style={styles.detailRow}>
                            ...
                            />
                            <ThemedText
                              style={[styles.detailText, { color: "#C62828" }]}
                            >
              ...
              <View style={styles.placeholderContainer}>
                ...
                <ThemedText
                  style={[styles.placeholderText, { color: iconColor }]}
                >
                  No consultation requests yet. Click "Create Schedule Now" to
                  ...
                  >
                    {teachers.length > 0 ? (
                      ...
                      <View style={styles.dropdownItem}>
                        <ThemedText
                          style={[styles.dropdownText, { color: iconColor }]}
                        >
            ...
            >
              ...
              <View style={styles.inputContainer}>
                ...
                <View
                  style={[
                    styles.inputWrapper,
                    { borderColor: iconColor, opacity: 0.6 },
                  ]}
                >
                  <TextInput
                    style={[styles.textInput, { color: textColor }]}
              ...
              <View style={styles.calendarGrid}>
                ...
                <View style={styles.androidDaysOfWeek}>
                  {["S", "M", "T", "W", "T", "F", "S"].map((day, index) => (
                    <ThemedText key={index} style={styles.androidDayOfWeek}>
                      {day}
                    </ThemedText>
                  ))}
                </View>
                ...
                <View style={styles.calendarDays}>
                  {Array.from({ length: 42 }, (_, index) => {
                    ...
                    if (dayNumber < 1 || dayNumber > daysInMonth) {
                      return (
                        <View key={index} style={styles.androidCalendarDay} />
                      );
                    }
